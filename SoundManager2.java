...
public class SoundManager2 {
    ...
    private static SoundManager2 instance = null;
    ...
    private SoundManager2(){
        ...
        // clip = loadClip("sounds2//background//beginnning.WAV");
        // clips.put("intro", clip);

        // clip = loadClip("sounds2//background//loop1.WAV");
    ...
    public static SoundManager2 getInstance(){
        if(instance == null)
            instance = new SoundManager2();
        return instance;
    }
