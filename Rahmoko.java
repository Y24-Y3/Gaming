...
public class Rahmoko implements Enemy{
	...
	public Rahmoko (TileMap2 map) {  
        ...
        spriteLeftImageIdle = ImageManager2.loadImage("images2/stein/idleLeft60x100.gif");
        spriteRightImageIdle = ImageManager2.loadImage("images2/stein/idleRight60x100.gif");
        spriteLeftImageAttack = ImageManager2.loadImage("images2/stein/attackLeft100x100.gif");
        spriteRightImageAttack = ImageManager2.loadImage("images2/stein/attackRight100x100.gif");
