...
*/
    ...
    public TileMapManager2(GamePanel2 panel) {
	this.panel = panel;
     ...
     public TileMap2 loadMap(String filename)
        throws IOException
    {
        ...
        TileMap2 newMap = new TileMap2(panel, mapWidth, mapHeight);
    ...
    private void addSprite(TileMap2 map,
        Enemy hostSprite, int tileX, int tileY)
    {
        if (hostSprite != null) {
            ...
            // center the sprite
            sprite.setX(
                TileMap2.tilesToPixels(tileX) +
                (TileMap2.tilesToPixels(1) -
                sprite.getWidth()) / 2);

            // bottom-justify the sprite
            sprite.setY(
                TileMap2.tilesToPixels(tileY + 1) -
                sprite.getHeight());
	...
	System.out.println("loadTileImages called.");
        ...
        char ch = 'A';
        while (true) {
            String filename = "images2/tiles/tile_" + ch + ".png";
